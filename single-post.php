                            ...
                            <form method="post">
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <input type="url" name="Web" class="form-control input-lg" placeholder="Website (optional)">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                        	<textarea cols="8" name="feed" rows="4" class="form-control input-lg" placeholder="Your comment"></textarea>
                                    	</div>
                                	</div>
                            	</div>
                            	<div class="row">
                                	<div class="form-group">
                                    	<div class="col-md-12">
                                        	<button type="submit" name="click" class="btn btn-primary btn-lg">Submit your feedback</button>
                                    	</div>
                                	</div>
                            	</div>
                        	</form>
          			...
          			<div class="col-md-3 sidebar">
                        <div class="widget sidebar-widget widget_recent_posts">
                            ...
                            <ul>
                            	<li>
                                    ...
                                    <h5><a href="single-post.php">2015 Proin enim quam, vulputate</a></h5>
                        ...
                        <div class="widget sidebar-widget widget_recent_reviews">
                            ...
                            <div class="post-block post-review-block">
                                ...
                                <h3 class="post-title"><a href="single-post-review.php">Curabitur nec nulla lectus, non hendrerit lorem porttitor eget</a></h3>
                            </div>
                            <div class="post-block post-review-block">
                                <div class="review-status">
                                    <strong>5.0</strong>
                                ...
                                <h3 class="post-title"><a href="single-post-review.php">2018 Proin enim quam, vulputate at lobortis quis, condimentum at justo</a></h3>
                            </div>
                        </div>
...
if(isset($submit))
{
    $in="insert into feedback values('','$name','$mail','website','$feedback')";
