                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-4 users-sidebar-wrapper">
                            ...
                            <div class="users-sidebar tbssticky">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item active"> <span class="badge">5</span> <a href="user-dashboard.php"><i class="fa fa-home"></i> Dashboard</a></li>
                                    ...
                                    <li class="list-group-item"> <a href="user-dashboard-settings.php"><i class="fa fa-cog"></i> Account Settings</a></li>
                        ...
                        <div class="col-md-9 col-sm-8">
                            ...
                            <div class="dashboard-block">
                            	<div class="dashboard-block-head">
                                	<a href="user-dashboard-saved-cars.php" class="btn btn-default btn-sm pull-right">See all Ads (2)</a>
                            		<h3>My Ads</h3>
                                </div>
                                    ...
                                    <table class="table table-bordered dashboard-tables saved-cars-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- Result -->
                                                    <a href="vehicle-details.php" class="car-image"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""></a>
                                                    <div class="search-find-results">
                                                        <h5><a href="vehicle-details.php">2010 BMW 125i E82 Coupe 2dr Auto 6sp 3.0i [MY10]</a></h5>
                                                        <ul class="inline">
                                                            <li>2 door Coupe</li>
                            ...
                            <div class="dashboard-block">
                            	<div class="dashboard-block-head">
                                	<a href="user-dashboard-saved-cars.php" class="btn btn-default btn-sm pull-right">See all cars (12)</a>
                            		<h3>Saved Cars</h3>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-bordered dashboard-tables saved-cars-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="vehicle-details.php" class="car-image"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""></a>
                                                    <div class="search-find-results">
                                                        <h5><a href="vehicle-details.php">2010 BMW 125i E82 Coupe</a></h5>
                                                        <ul class="inline">
                                                            <li>2 door Coupe</li>
                                                            <li>6 cyl, 3.0 L Petrol</li>
                                                            <li>6 speed Automatic</li>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="vehicle-details.php" class="car-image"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""></a>
                                                    <div class="search-find-results">
                                                        <h5><a href="vehicle-details.php">2010 BMW 125i E82 Coupe 2dr Auto 6sp 3.0i</a></h5>
                                                        <ul class="inline">
                                                            <li>2 door Coupe</li>
                                                            <li>6 cyl, 3.0 L Petrol</li>
                                                            <li>6 speed Automatic</li>
                            ...
                            <div class="dashboard-block">
                            	<div class="dashboard-block-head">
                                	<a href="user-dashboard-saved-cars.php" class="btn btn-default btn-sm pull-right">See all searches (5)</a>
