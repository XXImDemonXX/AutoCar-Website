                        ...
                        <div class="col-md-3 col-sm-4">
                            ...
                            <div class="users-sidebar tbssticky">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item active"> <a href="user-dashboard-profile.php"><i class="fa fa-user"></i> My Profile</a></li>
                            ...
                            <div class="dashboard-block">
                                <div class="tabs profile-tabs">
                                    ...
                                    <form method="post">
                                        ...
                                        <input type="submit" name="ud" value="Update details" class="btn btn-info">
                                    </form>
                                </div>
                            </div>
                       	</div>
...
if (isset($sub)) 
{
    $u=$_SESSION['username'];
    $cn=mysqli_connect('localhost','root','','vi');
    $cq="select ID from registration where User_Name=$u and Password=$old";
    $c=mysqli_query($cn,$cq);
