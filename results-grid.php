            	...
            	<div class="col-md-3 col-sm-3 search-actions">
                	<ul class="utility-icons tools-bar">
                    	<li><a href="#"><i class="fa fa-star-o"></i></a>
                        	<div class="tool-box">
                            	<div class="tool-box-head">
                            		<a href="user-dashboard-saved-cars.php" class="basic-link pull-right">View all</a>
                            		<h5>Saved cars</h5>
                                </div>
                                <div class="tool-box-in">
                                	<ul class="listing tool-car-listing">
                                    	<li>
                                            ...
                                            <div class="imageb"><a href="vehicle-details.php"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""></a></div>
                                            <div class="textb">
                                ...
                                <div class="tool-box-foot">
                                	<a href="joinus.php" class="btn btn-xs btn-primary pull-right">Join</a>
                    	...
                    	<li><a href="#"><i class="fa fa-folder-o"></i></a>
                        	<div class="tool-box">
                            	<div class="tool-box-head">
                            		<a href="user-dashboard-saved-searches.php" class="basic-link pull-right">View all</a>
                                ...
                                <div class="tool-box-in">
                                	<ul class="listing tool-view-listing">
                                    	<li>
                                            <div class="imageb"><a href="vehicle-details.php"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""></a></div>
                                            <div class="textb">
                                            	<a href="vehicle-details.php">Nissan Terrano first hand</a>
                                                <span class="price">$28000</span>
                                           	</div>
                                    	...
                                    	<li>
                                            <div class="imageb"><a href="vehicle-details.php"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""></a></div>
                                            <div class="textb">
                                            	<a href="vehicle-details.php">Mercedes Benz E class</a>
                                                <span class="price">$76000</span>
                                           	</div>
                                            <div class="save"><a href="#"><i class="fa fa-star-o"></i></a></div>
                                        </li>
                        	...
                        	<div id="results-holder" class="results-grid-view">
                            	...
                            	<div class="result-item format-standard">
                                	<div class="result-item-image">
                                		<a href="vehicle-details.php" class="media-box"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""></a>
                                        ...
                                        <div class="result-item-view-buttons">
                                        	...
                                        	<a href="vehicle-details.php"><i class="fa fa-plus"></i> View details</a>
                                        </div>
                                    </div>
                                	<div class="result-item-in">
                                     	<h4 class="result-item-title"><a href="vehicle-details.php">Nissan Terrano single hand driven</a></h4>
                                		<div class="result-item-cont">
                                            ...
                                            <div class="result-item-block col2">
                                                ...
                                                <div class="result-item-action-buttons">
                                                    ...
                                                    <a href="vehicle-details.php" class="btn btn-default btn-sm">Enquire</a><br>
                            	...
                            	<div class="result-item format-standard">
                                	...
                                	<div class="result-item-in">
                                     	<h4 class="result-item-title"><a href="vehicle-details.php">Mercedes Benz E Class</a></h4>
                                		<div class="result-item-cont">
                                            <div class="result-item-block col1">
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam..</p>
                                            </div>
                            	...
                            	<div class="result-item format-standard">
                                	...
                                	<div class="result-item-in">
                                     	<h4 class="result-item-title"><a href="vehicle-details.php">Nissan Sunny 1 owner, full service history , 18 inch alloy wheels</a></h4>
                                		<div class="result-item-cont">
                                            <div class="result-item-block col1">
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam..</p>
                                            </div>
                            	...
                            	<div class="result-item format-standard">
                                	...
                                	<div class="result-item-in">
                                     	<h4 class="result-item-title"><a href="vehicle-details.php">Nissan Micra</a></h4>
                                		<div class="result-item-cont">
                                            <div class="result-item-block col1">
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam..</p>
                                            </div>
                            	...
                            	<div class="result-item format-standard">
                                	...
                                	<div class="result-item-in">
                                     	<h4 class="result-item-title"><a href="vehicle-details.php">Mazda 2 Sedan</a></h4>
                                		<div class="result-item-cont">
                                            <div class="result-item-block col1">
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam..</p>
                                            </div>
                            	...
                            	<div class="result-item format-standard">
                                	...
                                	<div class="result-item-in">
                                     	<h4 class="result-item-title"><a href="vehicle-details.php">Mercedes Benz SL-300</a></h4>
                                		<div class="result-item-cont">
                                            <div class="result-item-block col1">
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam..</p>
                                            </div>
