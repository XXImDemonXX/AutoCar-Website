              	...
              	<div class="row">
                	<div class="col-md-9 posts-archive">
                  		<article class="post format-standard">
                    		<div class="row">
                      			<div class="col-md-4 col-sm-4"> <a href="single-post.php"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt="" class="img-thumbnail"></a> </div>
                    		...
                    		<div class="row">
                      			...
                      			<div class="col-md-8 col-sm-8">
                                    <div class="post-actions">
                                        ...
                                        <div class="comment-count"><a href="single-post.php"><i class="icon-dialogue-text"></i> 54</a></div>
                                    </div>
                    		...
                    		<div class="row">
                      			...
                      			<div class="col-md-8 col-sm-8">
                                    <div class="post-actions">
                                        ...
                                        <div class="comment-count"><a href="single-post.php"><i class="icon-dialogue-text"></i> 32</a></div>
                                    </div>
                    ...
                    <div class="col-md-3 sidebar">
                        ...
                        <div class="widget sidebar-widget widget_recent_reviews">
                            ...
                            <div class="post-block post-review-block">
                                ...
                                <h3 class="post-title"><a href="single-review-post.php">Lorem ipsum dolor sit amet, consectetur adipiscing elit</a></h3>
                            </div>
                            <div class="post-block post-review-block">
                                <div class="review-status">
                                    <strong>4.1</strong>
                                ...
                                <h3 class="post-title"><a href="single-review-post.php">Curabitur nec nulla lectus, non hendrerit lorem porttitor eget</a></h3>
                            </div>
                            <div class="post-block post-review-block">
                                <div class="review-status">
                                    <strong>5.0</strong>
                                ...
                                <h3 class="post-title"><a href="single-review-post.php">2018 Proin enim quam, vulputate at lobortis quis, condimentum at justo</a></h3>
                            </div>
                        </div>
                    </div>
              	</div>
