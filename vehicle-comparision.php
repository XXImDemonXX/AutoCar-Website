        	...
        	<div class="container">
                ...
                <div class="col3 comparision-table">
                	<div class="tsticky thead-sticky comp-table-row">
                        ...
                        <div class="comp-table-col">
                        	<strong>2018 Ford Territory SZ TX Sequential Sports Shift</strong>
                	...
                	<div class="comp-table-row">
                        ...
                        <div class="comp-table-col">2018</div>
                    </div>
                	<div class="comp-table-row">
                    ...
                    <div class="comp-table-row comp-table-permalinks">
                        <div class="comp-table-col">&nbsp;</div>
                        <div class="comp-table-col"><a href="vehicle-details.php" class="btn btn-primary btn-lg">View listing</a></div>
                        <div class="comp-table-col"><a href="vehicle-details.php" class="btn btn-primary btn-lg">View listing</a></div>
                        <div class="comp-table-col"><a href="vehicle-details.php" class="btn btn-primary btn-lg">View listing</a></div>
                    </div>
                </div>
