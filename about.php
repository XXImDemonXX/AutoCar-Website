...
<div class="body">
    ...
    <!-- Start Page header -->
    <div class="page-header parallax" style="background-image:url(http://placehold.it/1280x300&amp;text=IMAGE+PLACEHOLDER);">
    	<div class="container">
      		...
      		<div class="container">
            	<div class="row">
                	<div class="col-md-6">
                        ...
                        <p class="lead">The CarsInfo is the world's leading portal for<br>easy and quick <span class="accent-color">cars <!--buying and selling-->information providing website</span></p>
                    </div>
                    <div class="col-md-6">
