...
<div class="body">
    ...
    <div class="page-header parallax" style="background-image:url(http://placehold.it/1200x250&amp;text=IMAGE+PLACEHOLDER);">
    	<div class="container">
        	<h1 class="page-title">Dealers Search</h1>
       	</div>
    </div>
    <!-- Utiity Bar -->
        	...
        	<div class="row">
            	<div class="col-md-8 col-sm-6 col-xs-8">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Dealers Search Results</li>
                    </ol>
            	</div>
    ...
    <!-- Start Body Content -->
  	<div class="main" role="main">
    	<div id="content" class="content full padding-b0">
        	<div class="container">
            <a href="#gmap" class="scrollto btn btn-default btn-sm pull-right"><i class="fa fa-map-marker"></i> view on map</a>
                    ...
                    <div class="row">
                            ...
                            <div class="dealer-block-inner" style="background-image:url(http://placehold.it/600x300&amp;text=IMAGE+PLACEHOLDER);">
                            	<div class="dealer-block-cont">
                                    <div class="dealer-block-info">
                                        ...
                                        <h5><a href="dealer-prosite.php">Future Tranformers ELC</a></h5>
                                    ...
                                    <div class="text-align-center"><a href="dealer-prosite.php" class="btn btn-default">View profile</a></div>
                               	</div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-4 dealer-block">
                            <div class="dealer-block-inner" style="background-image:url(http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER);">
                            	<div class="dealer-block-cont">
                                    <div class="dealer-block-info">
                                        <span class="label label-default">4.2 miles away</span>
                                        <span class="dealer-avatar"><img src="http://placehold.it/80x80&amp;text=IMAGE+PLACEHOLDER" alt=""></span>
                                        <h5><a href="dealer-prosite.php">Car Sellers</a></h5>
                            ...
                            <div class="dealer-block-inner" style="background-image:url(http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER);">
                            	<div class="dealer-block-cont">
                                    <div class="dealer-block-info">
                                        ...
                                        <span class="dealer-avatar"><img src="http://placehold.it/80x80&amp;text=IMAGE+PLACEHOLDER" alt=""></span>
                                        <h5><a href="dealer-prosite.php">RedStars Automotives</a></h5>
