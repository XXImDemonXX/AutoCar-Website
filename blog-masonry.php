            	...
            	<ul class="grid-holder col-3 posts-grid">
              		<li class="grid-item post format-standard">
                		<div class="grid-item-inner">
                        	<a href="single-post.php" class="media-box"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""></a>
                  			<div class="grid-content">
                                ...
                                <h3 class="post-title"><a href="single-post.php">Suspendisse eget ligula in nulla iaculis interdum nec</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam... <a href="single-post.php" class="continue-reading">Continue reading <i class="fa fa-long-arrow-right"></i></a></p>
              		...
              		<li class="grid-item post format-standard">
                		<div class="grid-item-inner">
                        	<a href="single-post.php" class="media-box"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""></a>
                  			<div class="grid-content">
                                <div class="post-actions">
                                    <div class="post-date">December 27, 2018</div>
                                    <div class="comment-count"><a href="single-post.php"><i class="icon-dialogue-text"></i> 20</a></div>
                                </div>
                                <h3 class="post-title"><a href="single-post.php">'Donec' facilisis fermentum sem, ac viverra</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus... <a href="single-post.php" class="continue-reading">Continue reading <i class="fa fa-long-arrow-right"></i></a></p>
                                <div class="post-meta">Posted in: <a href="#">Financial</a></div>
                      		</div>
                		</div>
                 	</li>
                		...
                		<div class="grid-item-inner">
                        	<a href="single-post.php" class="media-box"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""></a>
                  			<div class="grid-content">
                                ...
                                <h3 class="post-title"><a href="single-post.php">2.1eh gestas rhoncus donec facilisis</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam... <a href="single-post.php" class="continue-reading">Continue reading <i class="fa fa-long-arrow-right"></i></a></p>
                                <div class="post-meta">Posted in: <a href="#">Financial</a></div>
                      		</div>
                		</div>
                 	</li>
                		...
                		<div class="grid-item-inner">
                        	<a href="single-post.php" class="media-box"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""></a>
                  			<div class="grid-content">
                                ...
                                <h3 class="post-title"><a href="single-post.php">Convallis egestas rhoncus donec facilisis adipiscing</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam... <a href="single-post.php" class="continue-reading">Continue reading <i class="fa fa-long-arrow-right"></i></a></p>
                                <div class="post-meta">Posted in: <a href="#">Financial</a></div>
                      		</div>
                		</div>
                		...
                		<div class="grid-item-inner">
                        	<a href="single-post.php" class="media-box"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""></a>
                  			<div class="grid-content">
                                ...
                                <h3 class="post-title"><a href="single-post.php">Lorem ipsum dolor sit amet, consectetur adipiscing elit</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam. Lorem ipsum dolor sit amet... <a href="single-post.php" class="continue-reading">Continue reading <i class="fa fa-long-arrow-right"></i></a></p>
                                <div class="post-meta">Posted in: <a href="#">Financial</a></div>
                      		</div>
                		</div>
                 	</li>
                		...
                		<div class="grid-item-inner">
                        	<a href="single-post.php" class="media-box"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""></a>
                  			<div class="grid-content">
                                ...
                                <h3 class="post-title"><a href="single-post.php">2015 Proin enim quam, vulputate</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam... <a href="single-post.php" class="continue-reading">Continue reading <i class="fa fa-long-arrow-right"></i></a></p>
                                <div class="post-meta">Posted in: <a href="#">Financial</a></div>
                      		</div>
                		</div>
